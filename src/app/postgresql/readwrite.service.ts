...
export class ReadwriteService {
  ...
  readData(): Observable<any> {
    return this.httpClient.get(`${this.REST_API}/postgres-users`);
  }

  deleteItem(id: any): Observable<any> {
    return this.httpClient.delete(`${this.REST_API}/postgres-users/${id}`);
  }

  writeUser(data: User): Observable<any> {
    return this.httpClient.post(`${this.REST_API}/postgres-users`, data);
  }
